...
[Установка](#-установка) • [Использование](#-использование) • [Функции](#-функции) • [Графический интерфейс](#-графический-интерфейс)
...
- ✅ **Графический интерфейс** - удобное управление из системного трея
...
![Zapret Tray GUI](https://raw.githubusercontent.com/Memdved/pictures_for_readme/refs/heads/main/Screenshot%202025-10-26%20210558.png)

**Удобное управление Zapret прямо из системного трея**

</div>

### Возможности GUI:
- 🎯 **Иконка в системном трее** - всегда под рукой
- 🔄 **Управление службой** - запуск, остановка, перезапуск одним кликом
- 📊 **Визуальный статус** - цвет индикатора показывает состояние службы
- ⚡ **Автозапуск** - автоматический запуск с правами администратора
- 🔔 **Уведомления** - информирование о действиях системы
...
python zapret_tray.py
\`\`\`

### Установка зависимостей для GUI:
\`\`\`batch
# Установка необходимых библиотек Python
install_requirements_fixed.bat
\`\`\`

### Настройка автозапуска:
\`\`\`batch
# Настройка автоматического запуска при входе в систему
setup_autostart.bat
\`\`\`
...
4. Для GUI запустите `install_requirements_fixed.bat` и `setup_autostart.bat`
...
| **`start_tray.bat`** | Запуск графического интерфейса | Администратор |
| **`setup_autostart.bat`** | Настройка автозапуска GUI | Администратор |
...
### 🖥️ Графический интерфейс (`zapret_tray.py`)
- Управление службой из системного трея
- Визуальный статус работы службы
...
- ✅ Запускает GUI при входе в систему
...
- GUI работает с минимальными привилегиями

## ❓ Частые вопросы

**Q: Нужно ли запускать скрипты от имени администратора?**  
...
**Q: GUI не запускается автоматически**  
A: Запустите `setup_autostart.bat` от имени администратора.

**Q: Не отображается иконка в трее**  
A: Проверьте "скрытые значки" в области уведомлений Windows.

**Q: Какие зависимости нужны для GUI?**  
A: Запустите `install_requirements_fixed.bat` для установки всех необходимых библиотек Python.
...
[⬆️ Вернуться к началу](#-zapret-auto-updater-system)
